...
public:
	...
	void sequence2(string language){
		if(lang=="en"){
			...
			save(); system("cls"); Sleep(1000);
			diadec1 = ""; diadec2 = ""; diadec3 = "";
			cout << "\n\n\n\n\n\n        {[()]} Akt 2 {[()]}\n\n\n"; Sleep(1000);FunctionDef.truenarrator("  Vedies si dobre!(ani velmi nie)", 50); Sleep(2000); system("cls"); Sleep(2500);
			cout << "\n";
			FunctionDef.truenarrator("Prechadzas cez nadhernu luku, plnu vtakov, mrtvych tiel a poskodenych zbrani.", 50); FunctionDef.skip(1000);
			cout << "\n\n";
			if(earlyexplanation==true) d = "5";
			else if(relwvoid==1) d = "1";
			else if(relwvoid==2) d = "2";
			...
			if(d=="1"){
				FunctionDef.MCS("Co sa tu do certa stalo?", 80); FunctionDef.skip(1000);
				cout << "\n";
				FunctionDef.narrator("Vyzera to tak, ze ludia nedavaju uz ani tvoju existenciu na tomto svete.", 80); FunctionDef.skip(400); FunctionDef.narratorclean(vc, " Bitka,", 80); FunctionDef.skip(250); FunctionDef.narratorclean(vc, " z mojho uhla pohladu.", 80); FunctionDef.skip(1000);
				cout << "\n\n"; FunctionDef.truenarrator("1) Drz uz konecne hubu.", 50); cout << "\n"; FunctionDef.truenarrator("2) Ospravedlnujem sa za to predtym.", 50); cout << "\n";
				cout << "\033[33m>>    ";
				diadec1 = FunctionDef.GVIclean(1,2);
				cout << "\033[0m";
				if(diadec1=="1"){
					FunctionDef.MCSC(mc, "Hej, a co keby si ty konecne drzal hubu, povedal mi co sa tu deje a kto vlastne si?", 80); FunctionDef.skip(1000); 
					cout << "\n";
					FunctionDef.narrator("Ty si tie usta nezavries,", 80); FunctionDef.skip(250); FunctionDef.narratorclean(vc, " co?", 100); FunctionDef.skip(400); FunctionDef.narratorclean(vc, " Nemozeme mat medzi sebou klud ani na chvilu,", 100); FunctionDef.skip(250); FunctionDef.narratorclean(vc, " ze?", 100); FunctionDef.skip(400); cout <<"\n"; FunctionDef.narrator("Ja by som ti velmi rad nieco povedal,", 80); FunctionDef.skip(250); FunctionDef.narratorclean(vc, " ale spravas sa ako", 80); FunctionDef.skip(250); FunctionDef.narratorclean(vc, " uplny,", 100); FunctionDef.skip(250); FunctionDef.narratorclean(vc, " kreten.", 80); FunctionDef.skip(400); FunctionDef.narratorclean(vc, " Chces sa dozvediet nieco nove?", 80); FunctionDef.skip(400); cout << "\n"; FunctionDef.narrator("Tak by si mi mal za toto spravanie venovat sakra velke ospravedlnenie.", 80); FunctionDef.skip(400); FunctionDef.narratorclean(vc, " Nemam ochotu byt zaseknuty v tele s nejakym dementom, ktory mi nedokaze verit.", 80); FunctionDef.skip(400); cout << "\n"; FunctionDef.narrator("Ja,", 100); FunctionDef.skip(250); FunctionDef.narratorclean(vc, " Prepac mi to.", 80); FunctionDef.skip(400); FunctionDef.narratorclean(vc, " Snazim sa byt mily,", 80); FunctionDef.skip(250); FunctionDef.narratorclean(vc, " aly ty,", 80); FunctionDef.skip(250); FunctionDef.narratorclean(vc, " ty ma proste nenechavas.", 80); FunctionDef.skip(1000);
					cout << "\n\n"; FunctionDef.truenarrator("1) Nie, vypadni z mojej hlavy!", 50); cout << "\n"; FunctionDef.truenarrator("2) ...", 50); cout << "\n"; FunctionDef.truenarrator("3) Prepac. Velmi sa ospravedlnujem za to predtym.", 80); cout << "\n";
					cout << "\033[33m>>    ";
					diadec2 = FunctionDef.GVIclean(1,3);
					cout << "\033[0m";
					if(diadec2=="1"){
