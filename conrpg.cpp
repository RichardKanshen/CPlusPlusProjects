...
public:
	...
	void d1n(string language) {
		if(language=="en"){
			if (a == 0){
				FunctionDef.truenarrator("Trees, interesting choice. You come closer to the trees but you don't find anything.", 50);
			} 
			if (a == 1){
				FunctionDef.truenarrator("For real? You visit the trees again, and... you don't find anything.", 50);
			}
			if (a == 2){
				FunctionDef.truenarrator("There is something weird about those trees. They're... trees.", 50);
			} 
			if (a > 2) {
			...
			if (a == 0){
				FunctionDef.truenarrator("Stromy, zaujimava volba. Isiel si blizsie ku stromom, ale nic si nenasiel.", 50);
			}
			if (a == 1){
				FunctionDef.truenarrator("Vazne? Prisiel si znova ku stromom, a... znova si nic nenasiel.", 50);
			}
			if (a == 2){
				FunctionDef.truenarrator("Nieco je divne na tych stromoch. Su ako... stromy.", 50);
			}
			if (a > 2) {
	...
	void introsequence(string language){
		if(language=="en"){
			...
			if(mode=="easy"){
				...
				cout << "\n\n"; FunctionDef.truenarrator("\t\tYou have 3 lives.", 50); 
				Sleep(2000); lives = 3;
			}
			else if(mode=="hard"){
				cout << "\n\n\n\n\n\n"; FunctionDef.truenarrator("\t\tHard mode...", 100); FunctionDef.skip(250);
				cout << "\n\n"; FunctionDef.truenarrator("\t\tYou have 1 life.", 50); 
				Sleep(2000); lives = 1;
			}
			else{
				cout << "\n\n\n\n\n\n"; FunctionDef.truenarrator("\t\tSpeedrun mode...", 100); FunctionDef.skip(250);
				cout << "\n\n"; FunctionDef.truenarrator("\t\tYou have 1 life and the game does not save. Godspeed on your adventure.", 50); 
				Sleep(2000); lives = 1;
			}
			...
			if (!playerName.empty()) {
				...
				if(mode=="easy"){
					...
					cout << "\n\n"; FunctionDef.truenarrator("\t\tMas 3 zivoty.", 50); 
					Sleep(2000); lives = 3;
				}
				else if(mode=="hard"){
					cout << "\n\n\n\n\n\n"; FunctionDef.truenarrator("\t\tTazka obtiaznost...", 100); FunctionDef.skip(250);
					cout << "\n\n"; FunctionDef.truenarrator("\t\tMas jeden zivot.", 50); 
					Sleep(2000); lives = 1;
				}
				else{
					cout << "\n\n\n\n\n\n"; FunctionDef.truenarrator("\t\tSpeedrun alias turbo obtiaznost...", 100); FunctionDef.skip(250);
					cout << "\n\n"; FunctionDef.truenarrator("\t\tMas jeden zivot a hra sa neuklada. Tvoja cesta bude mat tu spravnu rychlost.", 50); 
					Sleep(2000); lives = 1;
				}
				UlozitInfo(to_string(lives), "Lives.txt");
				sequence=0;
